            ...
            <tr>
                ...
                <td>
                    <table  class="action_table">
                        <tr>
                            <td width="25%"><a href="{SITE_URL}/admin/sound/update/id/{ID}/" title="Edit/Update" class="edit_state">Edit</a></td>
                            <td width="25%"><a href="{SITE_URL}/admin/sound/delete/id/{ID}/" title="Delete" class="delete_state">Delete</a></td>
                        </tr>
                    </table>
                </td>
            </tr>
